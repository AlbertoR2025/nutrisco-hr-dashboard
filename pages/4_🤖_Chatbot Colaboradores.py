# pages/4_🤖_Chatbot Colaboradores.py → VERSIÓN FINAL 2025: SIN FOTO/CORONA, SIMÉTRICO DESKTOP/MÓVIL (FIX V1.38 FOROS)
...
# ==================== CSS + JS DEFINITIVO 2025 (DE DISCUSS #80477 – .stAppDeployButton + [div:first-child]) ====================
st.markdown("""
<style>
