# pages/4_🤖_Chatbot Colaboradores.py → VERSIÓN FINAL 2025: SIN AVATAR/INPUT AVATAR/CORONA/HOSTED, RESPONSIVO MÓVIL PERFECTO
...
# ==================== CSS + JS DEFINITIVO 2025: OCULTA TODO (AVATAR INPUT, CORONA, HOSTED) ====================
st.markdown("""
<style>
    /* OCULTAR HEADER, MENU, TOOLBAR (estándar) */
    ...
    /* OCULTAR FOOTER HOSTED WITH STREAMLIT Y CORONA ROJA (selectores 2025) */
    ...
    /* OCULTAR AVATAR DEL USUARIO EN CHAT_INPUT Y MENSAJES (móvil/desktop) */
    [data-testid="stChatInput"] img, [data-testid="stChatMessage"] img[src*="avatar"], [data-testid="stAvatar"],
    img[alt="user avatar"], .css-h1sjnp, .e1d0834u0 {display: none !important; visibility: hidden !important; width: 0 !important; height: 0 !important; opacity: 0 !important;}

    /* LAYOUT RESPONSIVO CENTRADO (sin desalineaciones) */
    ...
    @media (max-width: 768px) {
        ...
        [data-testid="stChatInput"] {max-width: 100% !important; padding-bottom: 2rem !important;} /* Espacio extra para móvil */
    }
    .stApp {background-color: #0e1117 !important;}

    /* ESTILOS MENSAJES Y HEADER (naranja Nutrisco) */
    ...
    @media (max-width: 768px) {.user-message, .assistant-message {max-width: 95% !important; padding: 12px 16px !important; font-size: 1.1rem !important;}}
    ...
    .belén-box {background: #dc2626 !important; color: white !important; padding: 1.3rem !important; border-radius: 15px !important; text-align: center !important; font-weight: bold !important; margin: 2rem 0 !important; font-size: 1.15rem !important; box-shadow: 0 4px 15px rgba(220,38,38,0.4) !important;}
...
<!-- JS DINÁMICO: BORRA RESIDUALES EN MÓVIL (cada 500ms) -->
<script>
    setInterval(() => {
        const elements = document.querySelectorAll('footer, [data-testid="stDeployButton"], img[alt*="avatar"], div:contains("Streamlit"), div:contains("Hosted")');
